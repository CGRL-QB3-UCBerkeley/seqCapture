...
-l  INT      Self-blast to mask similar motifs shared 
             ...
             1 = yes 
             0 = no [0]          
-c  INT      complete mt genome (or most of it?)
             1 = yes  
             0 = no [0]    
-g  INT      for nuclear genes, retain flanking sequences or not
             1 = yes  
             0 = no [1]  
-L  INT      min length cutoff in initial cdhit to keep a assembled contig [200] 
...
if ($exon ne "4") {
  ...
  foreach (@files) {
    ...
    #my %assem2 = %{$assem2};
    #blastcut (\%assem2, $seqfile, $assembly1, $assem_cut);
